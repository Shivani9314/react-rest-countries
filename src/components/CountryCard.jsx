...
const CountryCard = ({ data }) => {
  ...
  return (
    <Link to={`/country/${data.cca3}`} className={`flex flex-col shadow-lg w-full rounded-md overflow-hidden ${darkMode ? 'bg-elementDark' : 'bg-elementLight'} ${darkMode ? 'text-white' : 'text-black'}`}>
